...
You may explore the dataset, read existing solutions in `{solutions_dir}/`, and run experiments.
When ready, call `submit_solution(code)` — it evaluates your code and returns the score immediately.
